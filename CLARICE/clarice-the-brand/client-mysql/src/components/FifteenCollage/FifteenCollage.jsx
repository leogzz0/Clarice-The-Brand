...
const FifteenCollage = ({ photos }) => {
  return (
    <div className="type-one-collage">
      ...
      <img src={photos[14]} alt="photo 12" className="full-width" />
      <div className="half-width">
        <img src={photos[15]} alt="photo 13" />
        <img src={photos[16]} alt="photo 14" />
      </div>
      <div className="half-width">
        <img src={photos[17]} alt="photo 13" />
        <img src={photos[18]} alt="photo 14" />
      </div>
      <img src={photos[19]} alt="photo 12" className="full-width" />
      <div className="half-width">
        <img src={photos[20]} alt="photo 13" />
        <img src={photos[21]} alt="photo 14" />
      </div>
    </div>
  );
};
